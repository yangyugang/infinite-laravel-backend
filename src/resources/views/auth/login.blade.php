@include('infinite::partials.header')
        ...
        <div class="p-lg panel md-whiteframe-z1 text-color m">
            ...
            <form name="form" action="{{ url('/admin/auth/login') }}" method="post">
                ...
                <div class="md-form-group float-label">
                    <input type="email" name="email" class="md-input" ng-model="user.email" required value="{{ old('email') }}">
                    <label>邮箱</label>
                </div>
                <div class="md-form-group float-label">
...
@include('infinite::partials.scripts')
